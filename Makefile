...
all: fwdpp_lite.o fwdpp_lite_intrusive.o fwdpp_simplify.o split_breakpoints.o
	...
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -o fwdpp_simplify fwdpp_simplify.o  split_breakpoints.o -lgsl -lgslcblas -ltcmalloc $(LDFLAGS)
